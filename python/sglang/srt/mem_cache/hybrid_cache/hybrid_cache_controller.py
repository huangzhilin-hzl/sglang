...
class HybridCacheController(BaseHiCacheController):
    ...
    def _extra_pool_backup(
        ...
        """Write non-redundant sidecar pools on every TP rank.

        Pools marked as TP-redundant share the MLA KV storage semantics: only
        TP0 writes them, while other TP ranks report success for bookkeeping.
        """
