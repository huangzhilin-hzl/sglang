    ...
    def _stream_output_generation(
        ...
        for req in reqs:
            ...
            if (
                ...
                acc.record_req_metrics(req=req)
...
class _GenerationStreamAccumulator:
    ...
    req_metrics: dict = field(default_factory=dict)
    ...
    def record_req_metrics(self, req: Req) -> None:
        ...
        self.req_metrics[req.rid] = req_metric
